## Pontos de Distribuição de Livro<br>Projeto Desenvolvimento de Sistemas II
...
Além disso, o projeto busca promover a leitura e facilitar o acesso à livros físicos, fornecendo percursos menores a serem percorridos.

## Ferramentas Utilizadas
- **Microsoft Excel** | Especificação de requisitos
- **StarUML** | Diagramas de Componentes, Sequência, Domínio e Casos de Uso
